...
class TestScabbers
{
    ...
    public function __construct()
    {
        $this->client = new Client([
            'base_uri' => 'http://172.20.9.103:5555/accio/', // macgrant
            'timeout'  => 6.0,
        ]);
    }
    ...
    public function accio(array $data)
    {
        ...
        $response = $this->client->post($data['function'], [
            'form_params' => [
                'function' => $data['function'],
                'token'    => 'd91WsAjl58IwnMfVYKtRsA6WeTYgIUUXcxDPe1jjIa4bKhmJn6LW4PVDGmvEoDg6',
                $key       => $data['key']
            ]
        ]);
