...
window.app = new Vue({
    ...
    methods: {
        hello: function hello() {
            // delegate
            __WEBPACK_IMPORTED_MODULE_0__svg_bg_js__["a" /* default */].testA();
        }
    },
    mounted: function mounted() {
        __WEBPACK_IMPORTED_MODULE_1__modules_form_helper_js__["a" /* default */].formLoaded();
        __WEBPACK_IMPORTED_MODULE_0__svg_bg_js__["a" /* default */].bgxyy('hello-svg-bg-perfect');
        // setBackground.testA()
    }
});
