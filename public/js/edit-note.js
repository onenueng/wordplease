...
Vue.component('panel', __webpack_require__(97));
Vue.component('input-text', __webpack_require__(18));
Vue.component('input-suggestion', __webpack_require__(102));
Vue.component('input-select', __webpack_require__(105));
Vue.component('input-textarea', __webpack_require__(110));
Vue.component('input-radio', __webpack_require__(115));
Vue.component('input-check', __webpack_require__(120));
Vue.component('input-check-group', __webpack_require__(125));
Vue.component('input-text-addon', __webpack_require__(128));

Vue.component('modal-document', __webpack_require__(133));
